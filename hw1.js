...
const Product = class Product {
     ...
     */
    static printProducts = (products) => {products.forEach(product => 
        console.log(`Product: ${product.name}, Cost: ${new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(product.price)}, Availability: ${product.availability === "In Stock" ? "Yes" : "No"}`))}
